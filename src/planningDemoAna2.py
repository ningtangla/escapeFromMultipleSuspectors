...
def main():
    ...
    alphaForStateWidening = 0.0
    CForStateWidening = 1.0
    cBase = 1000
    numTrees = 4
    numSimulationTimes = 163
    damp = 1.0
    rangeToCare = 20.0
    trajectoryFixedParameters = {'alpha': alphaForStateWidening, 'C': CForStateWidening, 'damp': damp, 'rangeToCare': rangeToCare,
    ...
    softId = 1.0
    softSubtlety = 1.0
    trajectoryParameters = {'minAttDist': minAttentionDistance, 'rangeAtt': rangeAttention, 'softId': softId, 'softSubtlety': softSubtlety}
