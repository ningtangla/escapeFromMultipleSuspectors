...
def main():     
    ...
    manipulatedVariables['alphaForStateWidening'] = [0.25, 0.75]
    ...
    manipulatedVariables['rangeAttention'] = [6.1]
    manipulatedVariables['cBase'] = [50, 500]
    manipulatedVariables['numTrees'] = [2, 3]
